...
#[inline]
pub(crate) const fn joining_group(cp: u32) -> JoiningGroup {
    match cp >> 8 {
        #[cfg(feature = "ascii")]
        0x000 => jg_p0(cp as u8),
        #[cfg(feature = "bmp")]
        0x006 => jg_p6(cp as u8),
        #[cfg(feature = "bmp")]
        0x007 => jg_p7(cp as u8),
        #[cfg(feature = "bmp")]
        0x008 => jg_p8(cp as u8),
        #[cfg(feature = "full")]
        0x10a => jg_p10a(cp as u8),
        #[cfg(feature = "full")]
        0x10d => jg_p10d(cp as u8),
        #[cfg(feature = "full")]
        0x10e => jg_p10e(cp as u8),
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "ascii")]
const fn jg_p0(b: u8) -> JoiningGroup {
    match b {
        _ => JoiningGroup::NoJoiningGroup,
    }
}
...
#[cfg(feature = "bmp")]
const fn jg_p6(b: u8) -> JoiningGroup {
    match b {
        0x20 => JoiningGroup::KashmiriYeh,
        0x22..=0x23 => JoiningGroup::Alef,
        0x24 => JoiningGroup::Waw,
        0x25 => JoiningGroup::Alef,
        0x26 => JoiningGroup::Yeh,
        0x27 => JoiningGroup::Alef,
        0x28 => JoiningGroup::Beh,
        0x29 => JoiningGroup::TehMarbuta,
        0x2a..=0x2b => JoiningGroup::Beh,
        0x2c..=0x2e => JoiningGroup::Hah,
        0x2f..=0x30 => JoiningGroup::Dal,
        0x31..=0x32 => JoiningGroup::Reh,
        0x33..=0x34 => JoiningGroup::Seen,
        0x35..=0x36 => JoiningGroup::Sad,
        0x37..=0x38 => JoiningGroup::Tah,
        0x39..=0x3a => JoiningGroup::Ain,
        0x3b..=0x3c => JoiningGroup::Gaf,
        0x3d..=0x3f => JoiningGroup::FarsiYeh,
        0x41 => JoiningGroup::Feh,
        0x42 => JoiningGroup::Qaf,
        0x43 => JoiningGroup::Kaf,
        0x44 => JoiningGroup::Lam,
        0x45 => JoiningGroup::Meem,
        0x46 => JoiningGroup::Noon,
        0x47 => JoiningGroup::Heh,
        0x48 => JoiningGroup::Waw,
        0x49..=0x4a => JoiningGroup::Yeh,
        0x6e => JoiningGroup::Beh,
        0x6f => JoiningGroup::Qaf,
        0x71..=0x73 => JoiningGroup::Alef,
        0x75 => JoiningGroup::Alef,
        0x76..=0x77 => JoiningGroup::Waw,
        0x78 => JoiningGroup::Yeh,
        0x79..=0x80 => JoiningGroup::Beh,
        0x81..=0x87 => JoiningGroup::Hah,
        0x88..=0x90 => JoiningGroup::Dal,
        0x91..=0x99 => JoiningGroup::Reh,
        0x9a..=0x9c => JoiningGroup::Seen,
        0x9d..=0x9e => JoiningGroup::Sad,
        0x9f => JoiningGroup::Tah,
        0xa0 => JoiningGroup::Ain,
        0xa1..=0xa6 => JoiningGroup::Feh,
        0xa7..=0xa8 => JoiningGroup::Qaf,
        0xa9 => JoiningGroup::Gaf,
        0xaa => JoiningGroup::SwashKaf,
        0xab => JoiningGroup::Gaf,
        0xac..=0xae => JoiningGroup::Kaf,
        0xaf..=0xb4 => JoiningGroup::Gaf,
        0xb5..=0xb8 => JoiningGroup::Lam,
        0xb9..=0xbc => JoiningGroup::Noon,
        0xbd => JoiningGroup::Nya,
        0xbe => JoiningGroup::KnottedHeh,
        0xbf => JoiningGroup::Hah,
        0xc0 => JoiningGroup::TehMarbuta,
        0xc1..=0xc2 => JoiningGroup::HehGoal,
        0xc3 => JoiningGroup::TehMarbutaGoal,
        0xc4..=0xcb => JoiningGroup::Waw,
        0xcc => JoiningGroup::FarsiYeh,
        0xcd => JoiningGroup::YehWithTail,
        0xce => JoiningGroup::FarsiYeh,
        0xcf => JoiningGroup::Waw,
        0xd0..=0xd1 => JoiningGroup::Yeh,
        0xd2..=0xd3 => JoiningGroup::YehBarree,
        0xd5 => JoiningGroup::TehMarbuta,
        0xee => JoiningGroup::Dal,
        0xef => JoiningGroup::Reh,
        0xfa => JoiningGroup::Seen,
        0xfb => JoiningGroup::Sad,
        0xfc => JoiningGroup::Ain,
        0xff => JoiningGroup::KnottedHeh,
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "bmp")]
const fn jg_p7(b: u8) -> JoiningGroup {
    match b {
        0x10 => JoiningGroup::Alaph,
        0x12 => JoiningGroup::Beth,
        0x13..=0x14 => JoiningGroup::Gamal,
        0x15..=0x16 => JoiningGroup::DalathRish,
        0x17 => JoiningGroup::He,
        0x18 => JoiningGroup::SyriacWaw,
        0x19 => JoiningGroup::Zain,
        0x1a => JoiningGroup::Heth,
        0x1b..=0x1c => JoiningGroup::Teth,
        0x1d => JoiningGroup::Yudh,
        0x1e => JoiningGroup::YudhHe,
        0x1f => JoiningGroup::Kaph,
        0x20 => JoiningGroup::Lamadh,
        0x21 => JoiningGroup::Mim,
        0x22 => JoiningGroup::Nun,
        0x23 => JoiningGroup::Semkath,
        0x24 => JoiningGroup::FinalSemkath,
        0x25 => JoiningGroup::E,
        0x26 => JoiningGroup::Pe,
        0x27 => JoiningGroup::ReversedPe,
        0x28 => JoiningGroup::Sadhe,
        0x29 => JoiningGroup::Qaph,
        0x2a => JoiningGroup::DalathRish,
        0x2b => JoiningGroup::Shin,
        0x2c => JoiningGroup::Taw,
        0x2d => JoiningGroup::Beth,
        0x2e => JoiningGroup::Gamal,
        0x2f => JoiningGroup::DalathRish,
        0x4d => JoiningGroup::Zhain,
        0x4e => JoiningGroup::Khaph,
        0x4f => JoiningGroup::Fe,
        0x50..=0x56 => JoiningGroup::Beh,
        0x57..=0x58 => JoiningGroup::Hah,
        0x59..=0x5a => JoiningGroup::Dal,
        0x5b => JoiningGroup::Reh,
        0x5c => JoiningGroup::Seen,
        0x5d..=0x5f => JoiningGroup::Ain,
        0x60..=0x61 => JoiningGroup::Feh,
        0x62..=0x64 => JoiningGroup::Gaf,
        0x65..=0x66 => JoiningGroup::Meem,
        0x67..=0x69 => JoiningGroup::Noon,
        0x6a => JoiningGroup::Lam,
        0x6b..=0x6c => JoiningGroup::Reh,
        0x6d => JoiningGroup::Seen,
        0x6e..=0x6f => JoiningGroup::Hah,
        0x70 => JoiningGroup::Seen,
        0x71 => JoiningGroup::Reh,
        0x72 => JoiningGroup::Hah,
        0x73..=0x74 => JoiningGroup::Alef,
        0x75..=0x76 => JoiningGroup::FarsiYeh,
        0x77 => JoiningGroup::Yeh,
        0x78..=0x79 => JoiningGroup::Waw,
        0x7a..=0x7b => JoiningGroup::BurushaskiYehBarree,
        0x7c => JoiningGroup::Hah,
        0x7d..=0x7e => JoiningGroup::Seen,
        0x7f => JoiningGroup::Kaf,
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "bmp")]
const fn jg_p8(b: u8) -> JoiningGroup {
    match b {
        0x60 => JoiningGroup::MalayalamNga,
        0x61 => JoiningGroup::MalayalamJa,
        0x62 => JoiningGroup::MalayalamNya,
        0x63 => JoiningGroup::MalayalamTta,
        0x64 => JoiningGroup::MalayalamNna,
        0x65 => JoiningGroup::MalayalamNnna,
        0x66 => JoiningGroup::MalayalamBha,
        0x67 => JoiningGroup::MalayalamRa,
        0x68 => JoiningGroup::MalayalamLla,
        0x69 => JoiningGroup::MalayalamLlla,
        0x6a => JoiningGroup::MalayalamSsa,
        0x70..=0x82 => JoiningGroup::Alef,
        0x86 => JoiningGroup::ThinYeh,
        0x89 => JoiningGroup::Noon,
        0x8a => JoiningGroup::Hah,
        0x8b..=0x8c => JoiningGroup::Tah,
        0x8d => JoiningGroup::Gaf,
        0x8e => JoiningGroup::VerticalTail,
        0x8f => JoiningGroup::Noon,
        0xa0..=0xa1 => JoiningGroup::Beh,
        0xa2 => JoiningGroup::Hah,
        0xa3 => JoiningGroup::Tah,
        0xa4 => JoiningGroup::Feh,
        0xa5 => JoiningGroup::Qaf,
        0xa6 => JoiningGroup::Lam,
        0xa7 => JoiningGroup::Meem,
        0xa8..=0xa9 => JoiningGroup::Yeh,
        0xaa => JoiningGroup::Reh,
        0xab => JoiningGroup::Waw,
        0xac => JoiningGroup::RohingyaYeh,
        0xae => JoiningGroup::Dal,
        0xaf => JoiningGroup::Sad,
        0xb0 => JoiningGroup::Gaf,
        0xb1 => JoiningGroup::StraightWaw,
        0xb2 => JoiningGroup::Reh,
        0xb3 => JoiningGroup::Ain,
        0xb4 => JoiningGroup::Kaf,
        0xb5 => JoiningGroup::Qaf,
        0xb6..=0xb8 => JoiningGroup::Beh,
        0xb9 => JoiningGroup::Reh,
        0xba => JoiningGroup::Yeh,
        0xbb => JoiningGroup::AfricanFeh,
        0xbc => JoiningGroup::AfricanQaf,
        0xbd => JoiningGroup::AfricanNoon,
        0xbe..=0xc0 => JoiningGroup::Beh,
        0xc1 => JoiningGroup::Hah,
        0xc2 => JoiningGroup::Gaf,
        0xc3 => JoiningGroup::Ain,
        0xc4 => JoiningGroup::AfricanQaf,
        0xc5..=0xc6 => JoiningGroup::Hah,
        0xc7 => JoiningGroup::Lam,
        0xc8 => JoiningGroup::Gaf,
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "full")]
const fn jg_p10a(b: u8) -> JoiningGroup {
    match b {
        0xc0 => JoiningGroup::ManichaeanAleph,
        0xc1..=0xc2 => JoiningGroup::ManichaeanBeth,
        0xc3..=0xc4 => JoiningGroup::ManichaeanGimel,
        0xc5 => JoiningGroup::ManichaeanDaleth,
        0xc7 => JoiningGroup::ManichaeanWaw,
        0xc9..=0xca => JoiningGroup::ManichaeanZayin,
        0xcd => JoiningGroup::ManichaeanHeth,
        0xce => JoiningGroup::ManichaeanTeth,
        0xcf => JoiningGroup::ManichaeanYodh,
        0xd0..=0xd2 => JoiningGroup::ManichaeanKaph,
        0xd3 => JoiningGroup::ManichaeanLamedh,
        0xd4 => JoiningGroup::ManichaeanDhamedh,
        0xd5 => JoiningGroup::ManichaeanThamedh,
        0xd6 => JoiningGroup::ManichaeanMem,
        0xd7 => JoiningGroup::ManichaeanNun,
        0xd8 => JoiningGroup::ManichaeanSamekh,
        0xd9..=0xda => JoiningGroup::ManichaeanAyin,
        0xdb..=0xdc => JoiningGroup::ManichaeanPe,
        0xdd => JoiningGroup::ManichaeanSadhe,
        0xde..=0xe0 => JoiningGroup::ManichaeanQoph,
        0xe1 => JoiningGroup::ManichaeanResh,
        0xe4 => JoiningGroup::ManichaeanTaw,
        0xeb => JoiningGroup::ManichaeanOne,
        0xec => JoiningGroup::ManichaeanFive,
        0xed => JoiningGroup::ManichaeanTen,
        0xee => JoiningGroup::ManichaeanTwenty,
        0xef => JoiningGroup::ManichaeanHundred,
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "full")]
const fn jg_p10d(b: u8) -> JoiningGroup {
    match b {
        0x02 => JoiningGroup::HanifiRohingyaPa,
        0x09 => JoiningGroup::HanifiRohingyaPa,
        0x19 => JoiningGroup::HanifiRohingyaKinnaYa,
        0x1c => JoiningGroup::HanifiRohingyaPa,
        0x1e => JoiningGroup::HanifiRohingyaKinnaYa,
        0x20 => JoiningGroup::HanifiRohingyaKinnaYa,
        0x23 => JoiningGroup::HanifiRohingyaKinnaYa,
        _ => JoiningGroup::NoJoiningGroup,
    }
}

#[cfg(feature = "full")]
const fn jg_p10e(b: u8) -> JoiningGroup {
    match b {
        0xc2 => JoiningGroup::Dal,
        0xc3 => JoiningGroup::Tah,
        0xc4 => JoiningGroup::Kaf,
        0xc6 => JoiningGroup::ThinNoon,
        0xc7 => JoiningGroup::Yeh,
        _ => JoiningGroup::NoJoiningGroup,
    }
}
