...
pub use predicates::{
    age, block, general_category, general_category_u32, indic_syllabic_category, is_alphabetic,
    is_assigned, is_control, is_dash, is_decimal_digit, is_default_ignorable, is_diacritic,
    ...
    is_whitespace, joining_type, CharExt, IndicSyllabicCategory, JoiningType,
};
pub use script::{
